        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="card">
                   ...
                   <div class="card-body">
                      <form role="form" action="{{ route('user.update'.$edit->id) }}" method="POST">
                          @csrf
                          ...
                          <div class="form-group row">
                             ...
                             <div class="col-sm-10">
                                <input type="text" class="form-control" name="password" placeholder="Enter password" value="{{$edit->password}}">
                             </div>
                          </div>
                          <div class="form-group row">
                             ...
                             <div class="col-sm-10">
                                <select class="form-control" id="exampleFormControlSelect" name="role"required>
                                    <option value="Admin" {{'1' == $edit->role ? 'selected' : ''}}>1</option>
                                    <option value="User" {{'0' == $edit->role ? 'selected' : ''}}>0</option>
                                </select>
                             </div>
                          </div>
                        </div>
